...
public static class CategoryRepository
{
    ...
    public static async Task<long?> InsertWithTransaction(Category category, NpgsqlTransaction tx) 
    {
        const string sql = @"
            INSERT INTO categories
                (name, description, parent_id, created_at)
            VALUES
                (@name, @description, @parentId, @createdAt)
            RETURNING id";
        ...
        cmd.Parameters.AddWithValue("createdAt", category.CreationDate);
