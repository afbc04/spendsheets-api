...
namespace PacketHandlers {
    ...
    public class PacketUtils {
        ...
        public static async Task<IResult> ValidateAndReply(HttpRequest request, TemplatePacket template, Func<PacketExtracted, Task<IResult>> act_if_valid) {

            (bool is_packet_valid, PacketFail? packet_failed, PacketExtracted? packet_extracted) = await PacketValidator.validate_packet(request, template);
