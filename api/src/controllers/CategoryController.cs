    ...
    public class CategoryController {
        ...
        public async Task<SendingPacket> Get(bool can_read, string _id) {
            ...
            return await ControllerHelper.IDIsNumber(_id, async (id) => {
                ...
                return category == null ? new PacketFail(404) : new PacketSuccess(200,CategoryResponse.ToJson(category,can_read));
        ...
        public async Task<SendingPacket> List(bool can_read, QueriesRequest? query_request) {
            ...
            var query = QTO.Category(can_read,query_request);
            ...
            return new PacketSuccess(200,new Pageable(
                ...
                query.page,
                values.count,
                values.list.Select(i => CategoryResponse.ToJson(i,can_read)).ToList()!)
                .to_json());
        ...
        public async Task<SendingPacket> Create(IDictionary<string,object> category_data) {
            ...
            try {
                ...
                if (id != null) {
                    ...
                    return new PacketSuccess(201,CategoryResponse.ToJson(new_category));
                }
                else
            ...
            return await ControllerHelper.IDIsNumber(_id, async (id) => {
                ...
                if (category == null)
                    ...
                    return await this.dao.Delete(id)
                        ? new PacketSuccess(200,CategoryResponse.ToJson(category))
                        : new PacketFail(422,"Error while deleting category from database");
                ...
                if (category == null)
                    ...
                    try {
                        ...
                        if (await this.dao.Update(updated_category))
                            return new PacketSuccess(200,CategoryResponse.ToJson(updated_category));
                        else
