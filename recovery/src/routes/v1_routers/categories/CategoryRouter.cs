...
/*
        ...
        app.MapPost("", async (HttpRequest request) => {
            ...
            var body = await ValidatorBodyMiddleware.ValidateBody(request, CategoryBodyValidatorsTemplate.Create());
            var resultPacket = await CategoryController.CreateCategory(body!);
            return resultPacket.Send();
